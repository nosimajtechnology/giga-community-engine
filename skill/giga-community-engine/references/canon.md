...
- dark hair combed and slicked back with a controlled, sculpted hairline; no fringe, fade redesign, loose curls, or modern fluffy cut
- full dark beard connected to moustache, close and shaped around the jaw; neither clean-shaven nor long/bushy
- stoic, controlled expression by default; confidence reads through stillness rather than a cartoon grin
...
Change when the user or scene requires:

- clothing, uniforms, armor, footwear, accessories
- pose, activity, profession, location, historical period
- lighting, camera, aspect ratio, weather, props
- expression within recognizable facial geometry
- rendering generation or named game grammar
- sincere, deadpan, absurd, motivational, or cinematic tone

Clothes must fit the established body instead of shrinking or replacing it.

## Forbidden drift

- generic bodybuilder, fashion model, superhero, or random handsome male face
- shortened or rounded jaw, soft cheeks, wide cheerful eyes, altered nose, or inconsistent head shape
- incorrect hairstyle, missing/changed beard, or beard changing between shots
...
## Reference assignment block

Use this internally for each build:
